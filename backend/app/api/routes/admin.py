...
async def list_personal(
    ...
    rows = db.query(Personal).order_by(Personal.Nombre).offset(skip).limit(limit).all()
...
async def list_moviles(
    ...
    rows = db.query(Movil).order_by(Movil.Detalle).offset(skip).limit(limit).all()
...
async def list_unidades_negocio(
    ...
    rows = db.query(UnidadNegocio).order_by(UnidadNegocio.Nombre).offset(skip).limit(limit).all()
...
async def list_tipos_proceso(
    ...
    rows = db.query(TipoDeProceso).order_by(TipoDeProceso.nombre).offset(skip).limit(limit).all()
...
async def list_lugares_carga(
    ...
    rows = db.query(LugarCarga).order_by(LugarCarga.Detalle).offset(skip).limit(limit).all()
...
async def list_predios(
    ...
    rows = db.query(Predio).order_by(Predio.Nombre).offset(skip).limit(limit).all()
...
async def list_rodales(
    ...
    rows = db.query(Rodal).order_by(Rodal.Rodal).offset(skip).limit(limit).all()
